          ...
          <div className="flex items-center justify-between">
            ...
            {channels.length > 0 && (
              <button
                ...
                className="flex items-center gap-2 text-xs font-bold text-primary sm:text-muted-foreground sm:hover:text-primary transition-colors"
              >
                <CheckSquare className={cn(
                  "h-4.5 w-4.5",
                  selectedIds.length === filteredChannels.length && selectedIds.length > 0 ? "text-primary" : "text-muted-foreground/30"
                )} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="h-11 w-full rounded-xl border border-border/40 bg-secondary/20 pl-9 pr-4 text-sm focus:border-primary/40 focus:outline-none focus:ring-4 focus:ring-primary/5 transition-all shadow-sm"
              />
            </div>

            <button
              onClick={() => setIsBulkImportOpen(true)}
              className="flex h-11 items-center justify-center gap-2 rounded-xl bg-secondary/40 px-4 text-sm font-bold text-foreground hover:bg-secondary/60 transition-all active:scale-95 shadow-sm"
            >
